...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            </div><!--AQUI TERMINA LA BARRA DE INTERFACE-->

            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">TE VISITAMOS</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Programa un servicio para nosotros</li>
                        </ol>
                    </div>
                </main>
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; AR CentralSolutions 2022</div>
                        </div>
                    </div>
                </footer>
            </div>
