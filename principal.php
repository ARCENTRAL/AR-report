...
<html lang="es">
    <head>
        ...
        <meta name="description" content="ALBA SEGURIDAD PRIVADA ELECTRONICA S.A. DE C.V." />
        <meta name="author" content="Ing.Miguel Angel Monsivais" />
        <title>AR - CentralSolutions</title>
        <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
        <link href="css/styles.css?1.4" rel="stylesheet" />
        <!--Manifest-->
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="principal.php"><img src="assets/img/logo_blanco2.png" alt=""></a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                ...
                                <?php } ?>
                                    <a class="nav-link" href="misreport.php">
                                        Mis reportes
                                    </a>
                            ...
                            <div class="collapse" id="collapsePagess" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="programvisita.php">
                                        Programar visita
                                    </a>                               
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePagesss" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="progrserv.php">
                                        Programar Servicio
                                    </a>                                 
                                </nav>
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="verserv.php" >
                                        Ver Servicios
                                    </a>                                 
                                </nav>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; ARCENTRALSOLUTIONS 2022</div>
                        </div>
                    </div>
                </footer>
            </div>
